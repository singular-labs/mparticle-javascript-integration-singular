var SingularKit = (function (exports) {
   ...
   CommerceHandler.prototype.logCommerceEvent = function(event) {
       event.EventCategory = 16;
       console.log('commerce event ' + JSON.stringify(event));
      // var expandedEcommerceItems = mParticle.eCommerce.expandEcommerceEvent(event);
      // console.log('commerce expanded event ' + JSON.stringify(expandedEcommerceItems))
       ...
       if(event.ProductAction && event.ProductAction.ProductList && event.ProductAction.ProductList.length != 0){
           for (let i = 0 ; i < event.ProductAction.ProductList.length ; i++){
               if (event.EventCategory == 16 && event.ProductAction){
                   ...
                   console.log('handling regular event');
   ...
   */
   ...
   var SDKsettings = {
       apiKey: 'realprodcorp1',
       secret:'d38bfbce70b42a70fe920f425e73d123',
       productId:'Product'
   };
